...
- `STATUS_2026-05-28.md`: residual+gate, eval/video, runtime config, state observation mode, code-review 후속 상태 스냅샷
...
- `CODE_REVIEW_2026-05-26.md`: `il/` 전체 코드 리뷰 finding과 2026-05-28 기준 해결/미해결 상태
...
- `config/smoke_residual_td3_square.yaml`: frozen BCFlow base + residual TD3 learner rollout smoke
