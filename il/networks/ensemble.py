...
class Ensemble(nn.Module):
    """Replicate a network class into an independently-parameterized ensemble."""
    ...
    def __call__(self, *args):
        """Evaluate every ensemble member and stack outputs on axis 0."""
        ensemble = nn.vmap(
            self.net_cls,
...
def subsample_ensemble(key: jax.random.PRNGKey, params, num_sample: int, num_qs: int):
    """Randomly select a subset of ensemble parameter slices."""
